...
function tbs_enqueue_scripts()
{
	...
	wp_enqueue_script('tbs-app', get_template_directory_uri() . '/static/js/app.js', [], '0.0.1');
	...
	wp_enqueue_script('tbs-slick', get_template_directory_uri() . '/static/lib/slick/slick/slick.min.js');
}
